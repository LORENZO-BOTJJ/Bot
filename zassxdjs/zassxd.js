...
text: '', 
templateButtons: [
{ callButton: { displayText: `Number Phone Owner`, phoneNumber: `6281224172387`}},
{ urlButton: { displayText: `OWNER`, url: `https://wa.me/6281224172387`}},
...
await zassxd.sendMessage(m.chat, {
text: "Berikut list server *ZassXd*",
footer: `Page: ${res.meta.pagination.current_page}/${res.meta.pagination.total_pages}`,
title: "*ZassXd*",
